...
void show_help()
{
        ...
        printf("\n");
        printf("Sends email notification when a USB or SDCard device is plugged "
                        "into your computer, powered by Canary Tokens\n");
        printf("\n");
        printf("Options:\n");
        printf(BOLD_TEXT "-v, --version\n" NO_BOLD_TEXT);
        printf("\t\tthis prints the canaryusb version\n");
        printf(BOLD_TEXT "-c, --canary-token [DNS canary token]\n" NO_BOLD_TEXT);
        printf("\t\tcreated token from Canary token site: "
                        "https://canarytokens.org/generate\n");
        printf("\t\tyou'll receive the notification based on the created "
                        "DNS token\n");
        printf("\t\tto know more about it check: "
                        "https://docs.canarytokens.org/guide/dns-token.html\n");
        printf(BOLD_TEXT "-f, --fingerprint-device\n" NO_BOLD_TEXT);
        printf("\t\tthis prints the fingerprint related with a USB or SDCard "
                        "device that is plugged into computer\n");
        printf("\t\tand could be used to create the list for " BOLD_TEXT 
                        "trust-list" NO_BOLD_TEXT " option.\n");
        printf("\t\tIn this mode, will not be any call to Canary Tokens, only "
                        "the device fingerprint will be printed.\n");
        printf("\t\tAlso will not start a daemon, to quit" BOLD_TEXT 
                        " ctrl+c\n" NO_BOLD_TEXT);
        ...
        printf("\t\t" BOLD_TEXT "note:" NO_BOLD_TEXT " that the USB storage "
                        "devices will be also monitored.\n");
        printf(BOLD_TEXT "-t, --trust-list [comma separated device fingerprint list]\n" 
                        NO_BOLD_TEXT);
        printf("\t\tlist of device fingerprints, comma seprated, to not notify "
                        "when the related deviced is connected\n");
        ...
        printf("If any option is not provided the default behaviour is try to "
                        "retrieve the options from the a config file located at " 
                        BOLD_TEXT "~/.config/canaryusb/config.toml\n" NO_BOLD_TEXT);
        printf("An example of this configuration file is under " BOLD_TEXT 
                        "configuration/ " NO_BOLD_TEXT "directory at the repo.\n");
